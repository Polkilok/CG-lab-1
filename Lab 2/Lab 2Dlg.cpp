...
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Text(pDX, LB_msg, lb_msg);
	DDX_Control(pDX, ID_picture, picture_control);
}
...
BEGIN_MESSAGE_MAP(CLab2Dlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(BT_paint, &CLab2Dlg::OnBnClickedpaint)
END_MESSAGE_MAP()
...
void CLab2Dlg::OnBnClickedpaint()
{
	BYTE Black[] =
	{
